...
import ir.hamedgh.adminkindnesswall.customviews.textview.TextViewIranSansRegular;
import ir.hamedgh.adminkindnesswall.helper.ApiRequest;

import ir.hamedgh.adminkindnesswall.helper.DeviceInfo;
import ir.hamedgh.adminkindnesswall.helper.NumberTranslator;
import ir.hamedgh.adminkindnesswall.helper.Snackbari;
import ir.hamedgh.adminkindnesswall.helper.Toasti;
...
//	@BindView(R2.id.main_toolbar)
    Toolbar mToolbar;
//
//	@BindView(R2.id.toolbar_title_textView)
	TextView mToolbarTitleTextView;
//
//	@BindView(R2.id.toolbar_back_iv)
	ImageView mBackBtn;
//
//	@BindView(R2.id.second_btn_lay)
	RelativeLayout secondBtnLay;
//
//	@BindView(R2.id.second_btn_tv)
	TextView secondBtnTv;
//
//	@BindView(R2.id.login_get_verification_btn)
	RelativeLayout loginGetVerificationBtn;
//
//	@BindView(R2.id.phone_confirimation_code_et)
	EditTextIranSans phoneConfirimationCodeEt;
//
//	@BindView(R2.id.login_get_verification_tv)
...
//	@BindView(R2.id.progressView)
	...
	private void findViews(){
		...
		mToolbarTitleTextView = findViewById(R.id.toolbar_title_textView);
		mBackBtn = findViewById(R.id.toolbar_back_iv);
		secondBtnLay = findViewById(R.id.second_btn_lay);
		secondBtnTv = findViewById(R.id.second_btn_tv);
		loginGetVerificationBtn = findViewById(R.id.login_get_verification_btn);
		phoneConfirimationCodeEt = findViewById(R.id.phone_confirimation_code_et);
		login_get_verification_tv = findViewById(R.id.login_get_verification_tv);
